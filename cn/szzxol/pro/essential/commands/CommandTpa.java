    ...
    public static void TPA(Player player, String TargetName) {
        ...
        for (Player target : AllPlayers) {
            if (TargetName == null ? false : TargetName.equals(target.getName())) {
                ...
                player.sendMessage((new StringBuilder()).append(ChatColor.GOLD).append("已向玩家 ").append(ChatColor.WHITE).append(TargetName).append(ChatColor.GOLD).append(" 发送了传送请求").toString());
